# Python 3
# This script intended for manage the whole process
# The general flow is next:
# 1. Check today's date to check a need of aggregation of folders
# 1.1. If today is a new month - run monthly folders aggregation
...
if __name__ == "__main__":
    ...
    aggregator = aggregation.Aggregator(f'.{config.os_path[current_os]}.\
    {config.os_path[current_os]}directories', current_os)
